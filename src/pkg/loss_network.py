...
class LossNet(nn.Module):
    def __init__(self, vgg_path):
        ...
        # This is not the simplest way to load specific layers
        # But time was scarce when writing this
    ...
    def forward(self, x, out_key, gpu = True):
        ...
        out = {}
        # This is verbose but explicit is better than implicite
        ...
        # Return specific layers when performing feature extraction
...
class TemporalLoss(nn.Module):
    """
    TO BE FIXED, this is not working properly.
    Probably because of the opticalflow
    x: frame t 
