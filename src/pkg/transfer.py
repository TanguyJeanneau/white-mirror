...
class Transfer:
    ...
    def train(self):
        """
        behold the magnificient training function
        """
        ...
        if self.gpu:
            ...
            print('loaded models and style on CUDA')
        ...
        for count in range(self.epoch):
            ...
            for step, frames in enumerate(loader):
                ...
                for i in range(1, lf):
                    ...
                    # So far I haven't included it here, it was damaging performances.
                    # tv_loss = self.tv_loss(x_t)

                    # calculate optical flow
                    # Should be improved with DeepFlow.
